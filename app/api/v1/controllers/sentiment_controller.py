...
ASSOCIATE 4 — implement the handle() method below.
...
class SentimentController:
    """Handles HTTP concerns for the /sentiment endpoint."""

    def __init__(self, pipeline: SentimentPipeline) -> None:
        self.pipeline = pipeline

    def handle(self, request: SentimentRequest) -> SentimentResponse:
        """
        Process a sentiment request.
        ...
        Args:
            request: Validated SentimentRequest from the router.
